...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-laptop"></i> Souscriptions</h3>
        <ol class="breadcrumb">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    @if($souscription->statut == 0)
                                        ...
                                        <li class="divider"></li>
                                        @if($souscription->statut_install == 0 || $souscription->statut_install == 1)
                                            <li class="disabled"><a class="validation" href="" id="{{$souscription->id}}" data-toggle="modal" data-target="#validateModal">Valider</a></li>
                                        @else
